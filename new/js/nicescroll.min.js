(function (e) {
    ...
    c.forEach(function (e) {
        if (!h) h = window[e + "RequestAnimationFrame"];
        if (!p) p = window[e + "CancelAnimationFrame"] || window[e + "CancelRequestAnimationFrame"]
    });
    ...
    var v = {
        ...
        cursoropacitymin: 0,
        cursoropacitymax: .8,
        cursorcolor: "rgba(255, 156, 7, 0.74)",
        cursorwidth: "9px",
        cursorborder: "0",
    ...
    var y = function (e, r) {
        ...
        if (c.cantouch && c.ismozilla && !c.isios) {
            this.istouchcapable = true;
            c.cantouch = false
        }
        ...
        this.updateScrollBar = function (e) {
            if (a.ishwscroll) {
                ...
                n.top += E(a.win, "border-top-width", true);
                ...
                if (a.railh && !a.locked) {
                    var n = {top: t.top, left: t.left};
                    var s = a.railh.align ? n.top + E(a.win, "border-top-width", true) + a.win.innerHeight() - a.railh.height : n.top + E(a.win, "border-top-width", true);
                    var o = n.left + E(a.win, "border-left-width");
        ...
        this.init = function () {
            ...
            if (!a.ispage || !c.cantouch && !c.isieold && !c.isie9mobile) {
                ...
                if (a.ispage && c.isie7) {
                    if (a.doc[0].nodeName == "BODY") a.css(u("html"), {"overflow-y": "hidden"}); else if (a.doc[0].nodeName == "HTML") a.css(u("body"), {"overflow-y": "hidden"})
                }
                if (c.isios && !a.ispage && !a.haswrapper) a.css(u("body"), {"-webkit-overflow-scrolling": "touch"});
                ...
                if (a.ispage) {
                    ...
                    if (a.ishwscroll) {
                        ...
                        s.css({position: E});
                        if (a.zoom) a.zoom.css({position: E});
                        a.updateScrollBar();
                        a.body.append(s);
                ...
                if (c.isie9mobile) {
                    ...
                    if (a.opt.enablemousewheel) {
                        if (!a.isiframe) a.bind(c.isie && a.ispage ? document : a.docscroll, "mousewheel", a.onmousewheel);
            ...
            this.doScrollPos = function (e, t, n) {
                function c() {
                    ...
                    if (e == 2) {
                        ...
                        if (r != a.newscrollx || t != a.newscrolly) a.doScrollPos(r, t); else {
                            if (a.onscrollend) {
                                var i = {
                                    type: "scrollend",
                                    current: {x: sx, y: sy},
        ...
        this.doZoomIn = function (e) {
            ...
            a.win.css({position: c.isios4 ? "absolute" : "fixed", top: 0, left: 0, "z-index": o + 100, margin: "0px"});
